...
<form action="<?php echo JRoute::_('index.php?option=com_jongman&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="schedule-form" class="form-validate">
    <div class="width-60 fltlft">
        <fieldset class="adminform">
            <legend><?php echo empty($this->item->id) ? JText::_('COM_JONGMAN_SCHEDULE_NEW') : JText::sprintf('COM_JONGMAN_SCHEDULE_EDIT', $this->item->id); ?></legend>
            <ul class="adminformlist">
                ...
                <li><?php echo $this->form->getLabel('view_days'); ?>
                    <?php echo $this->form->getInput('view_days'); ?></li>
                    
                <li><?php echo $this->form->getLabel('timezone'); ?>
                    <?php echo $this->form->getInput('timezone'); ?></li>
                    
                <li><?php echo $this->form->getLabel('time_format'); ?>
                    <?php echo $this->form->getInput('time_format'); ?></li>

                <li><?php echo $this->form->getLabel('admin_email'); ?>
                    <?php echo $this->form->getInput('admin_email'); ?></li>

                <li><?php echo $this->form->getLabel('notify_admin'); ?>
                    <?php echo $this->form->getInput('notify_admin'); ?></li>
