...
class FrontendWeblinksCest
{
    ...
    /**
     * Create a JONGman in the backend and confirm it exists and is visible in the Frontend
     *
     * @param   \Step\Acceptance\Jongman  $I
     */

    public function createJongmanAndConfirmFrontend(\Step\Acceptance\Jongman $I, $scenario)
    {
        $scenario->skip('Temporarily skipped for drone, see: https://github.com/soap/jongman/issues/261');
        ...
        $I->amOnPage('index.php?option=com_jongman');
