								...
								<tr>
									<td class="wrapper last">
										...
										<table class="twelve columns">
											<tr>
												<td>
													<h1>Hi, {AUTHOR_NAME}</h1>
													<p class="lead">{YOUR_DOCUMENT_WAS_PROCESSED_BY_ACTOR}
													</p>
													<p>{DOCUMENT_DETAIL}</p>
												</td>
												<td class="expander"></td>
										...
										<table class="six columns">
											<tr>
												<td class="last right-text-pad">
													<h5>Contact Info:</h5>
													<p>Phone: 081-597-8397</p>
													<p>
														Email: <a href="mailto:prasit.gebssap@gmail.com">Prasit.Gebsaap-At-Gmail.com</a>
													</p>
												</td>
												<td class="expander"></td>
											</tr>
