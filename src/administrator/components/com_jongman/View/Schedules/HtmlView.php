...
namespace Soap\Component\Jongman\Administrator\View\Schedules;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        JongmanHelper::addSubmenu('schedules');
    ...
    protected function addToolbar()
    {
        ...
        \JToolbarHelper::title(\JText::_('COM_JONGMAN_MANAGER_SCHEDULES'), 'bookmark schedules');

        $canDo = ContentHelper::getActions('com_jongman', 'schedule');
        ...
        if ($canDo->get('core.edit.state'))
        {
            ...
            if ($this->state->get('filter.published') != -1)
            {
                if ($this->state->get('filter.published') != 2)
                {
                    \JToolbarHelper::archiveList('schedules.archive');
                }
                elseif ($this->state->get('filter.published') == 2)
                {
                    \JToolbarHelper::unarchiveList('schedules.publish');
                }
            }
        }
        ...
        {
            \JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'schedules.delete', 'JTOOLBAR_EMPTY_TRASH');
        }
        elseif ($canDo->get('core.edit.state'))
        {
            \JToolbarHelper::trash('schedules.trash');
        }
